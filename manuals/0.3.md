...
To make a comment in RCLF you need to add `//` and then you can write comment and it will not be interpreted by rclf interpreter
...
&c[105]
"Name";"Amount"
"QMAQ":"31000" // Comment. I am comment!
&e
```